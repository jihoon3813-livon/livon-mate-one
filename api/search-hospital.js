...
const KAKAO_REST_KEY = process.env.KAKAO_REST_KEY || 'KakaoAK 6d1fa1d735dbf6e1e8beb4ed7de2e3b4';
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ success: true, query, count: list.length, items: list });
  } catch (err) {
